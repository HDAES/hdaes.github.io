import{_ as s,c as n,o as a,O as e}from"./chunks/framework.4f00588c.js";const y=JSON.parse('{"title":"Typescript 装饰器","description":"","frontmatter":{},"headers":[],"relativePath":"ts/ts-decorator.md","filePath":"ts/ts-decorator.md","lastUpdated":1683366975000}'),l={name:"ts/ts-decorator.md"},p=e(`<h1 id="typescript-装饰器" tabindex="-1">Typescript 装饰器 <a class="header-anchor" href="#typescript-装饰器" aria-label="Permalink to &quot;Typescript 装饰器&quot;">​</a></h1><p><img src="https://hades0512.oss-cn-beijing.aliyuncs.com/1_h4DYwjRrrzrv6Wg5E8k2aA.png" alt=""></p><h2 id="介绍" tabindex="-1">介绍 <a class="header-anchor" href="#介绍" aria-label="Permalink to &quot;介绍&quot;">​</a></h2><p>随着TypeScript和ES6中类的引入，现在存在某些场景需要额外的功能来支持注释或修改类和类成员。装饰器提供了一种为类声明和成员添加注释和元编程语法的方法。装饰器是JavaScript的第二阶段建议，并作为TypeScript的一个实验性功能提供。</p><h2 id="如何开启" tabindex="-1">如何开启 <a class="header-anchor" href="#如何开启" aria-label="Permalink to &quot;如何开启&quot;">​</a></h2><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">修改tsconfig.json文件</span></span>
